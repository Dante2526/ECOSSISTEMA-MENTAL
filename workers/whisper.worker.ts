    ...
    try {
        ...
        const output = await transcriber(audio, {
            ...
            generate_kwargs: {
                ...
                prompt: "Código de linha, orbe 151, um cinco um, cento e cinquenta e um, 187, um oito sete, cento e oitenta e sete, 167, um meia sete, cento e sessenta e sete, 01, zero um, zero hum, 201-B, dois zero um b, estação, pial."
            }
        });
